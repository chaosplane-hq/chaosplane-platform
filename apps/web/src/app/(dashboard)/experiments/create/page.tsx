...
import { ArrowLeft, Send, Flow } from '@carbon/icons-react';
...
import { ACTION_PARAMS, MODE_OPTIONS } from '@/lib/fault-params';
    ...
    <Grid fullWidth>
      <Column lg={16} md={8} sm={4}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--cds-spacing-04)', marginBottom: 'var(--cds-spacing-05)' }}>
          ...
          <Button kind="ghost" size="sm" renderIcon={Flow} onClick={() => router.push('/experiments/scenario')}>
            Switch to multi-step scenario builder
          </Button>
        </div>
